...
This tree is the **DON** AGPL-3.0 fork (see FORK.md). Keep AGPL compliance when distributing. Do not re-introduce official Donut auto-updates or paid local feature gates.
